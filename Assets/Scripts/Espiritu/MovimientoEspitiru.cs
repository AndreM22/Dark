...
public class MovimientoEspitiru : MonoBehaviour
{
    ...
    public void DetenerAtaque()
    {
        ...
        GameObject hechizo = Instantiate(hechizoPrefab, transform.position + direction * 1f, Quaternion.identity);
        hechizo.GetComponent<HechizoScript>().setDirection(direction);
